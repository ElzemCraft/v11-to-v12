...
let toplama = "hhttps://v11-to-v12-dc-.glitch.me/toplam"
...
function openLink(value) {
    if (value == "toplama") {
        window.location.href("https://v11-to-v12-dc-.glitch.me/toplam")
    }
  }
  ...
  if (!req.query.message) {
    ...
    var asıl = req.query.message
      ...
      .join("cache.forEach");
        ...
        yusuffozen(asıl, { extension: "CızCızz" }).then(x => res.redirect(x));
   
  }
});


const toplamç = db.fetch(`toplamç`)
